                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="{{ asset('/admin/dashboard') }}" class="d-block auth-logo">
                                        <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt=""
                                            height="28"> <span class="logo-txt">DELIVE</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Welcome Back !</h5>
                                        <p class="text-muted mt-2">Sign in to continue to DELIVE.</p>
                                    </div>
                                    <x-error-messages />
                                    <x-session-messages />
                                    <form class="mt-4 pt-2" action="{{ route('admin.login_submit') }}" method="post">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" class="form-control" id="email" aria-describedby="emailHelp" required placeholder="メールアドレスを入れてください">
                                        </div>
                                        <div class="mb-3">
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div class="">
                                                        <a href="{{ route('admin.forget_password') }}" class="text-muted">パスワードを忘れましたか?</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="input-group auth-pass-inputgroup">
                                                <input type="password" name="password" placeholder="パスワードを入力してください" class="form-control" aria-label="Password" aria-describedby="password-addon">
